...
const Hero = () => {
  return (
    <section
      id="home"
      className={`flex md:flex-row flex-col px-6 py-10 bg-[#F7F7FD] md:mb-[140px] lg:mb-[0px] `}
    >
      <div className={`flex-1 flex-col pl-[40px] md:pl-[150px]`}>
        ...
        <div className="">
          <div className="flex lg:justify-evenly flex-col lg:flex-row lg:w-[50%]  bg-[#fff] shadow-2xl p-8 lg:absolute mb-12 mt-12 items-center z-[100]">
            <div  className=" px-2 py-2 bg-[#7065F0] mb-8 md:mb-0  cursor-pointer rounded-md text-[#fff] shadow-2xl"><Link to="/category/rent">PLaces for rent</Link></div>
